 ...
 */
public class CouchbaseDefaultBucketManagerTest extends ImportJobTestCase {
  public static final Log LOG = LogFactory.getLog(
      CouchbaseDefaultBucketManagerTest.class.getName());
  ...
  private String[] getArgv() {
    ...
    args.add(CouchbaseDefaultBucketUtils.COUCHBASE_CONN_MANAGER);
    args.add("--table");
    args.add(TABLE_NAME);
    args.add("--warehouse-dir");
    args.add(getWarehouseDir());
    args.add("--connect");
    args.add(CouchbaseDefaultBucketUtils.CONNECT_STRING);
    args.add("--username");
    args.add(CouchbaseDefaultBucketUtils.COUCHBASE_USER_NAME);
    args.add("--password");
    args.add(CouchbaseDefaultBucketUtils.COUCHBASE_USER_PASS);
